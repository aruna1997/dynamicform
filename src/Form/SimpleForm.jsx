                    ...
                    <h2>Form</h2>
                        ...
                        <div className="form-group col-xs-5">
                            ...
                            <div>{this.props.editData?null:<div className="form-group col-xs-5">
                                <label>Email:</label>
                                <input type="email" className="form-control" name="email" placeholder="Enter email" value={this.state.field.email} onChange={this.handleUpdate}/>
                                <div className="error-block">{this.state.error.email}</div>
                            </div>}
                            </div>
                           <div>{this.props.editData?null:<div className="form-group col-xs-5">
                                <label>Password:</label>
                                <input type="password" className="form-control" name="password" placeholder="Enter password" value={this.state.field.password} onChange={this.handleUpdate}/>
